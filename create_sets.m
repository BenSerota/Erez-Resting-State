...
EEG = pop_saveset( EEG, 'filename',['RS_EC_S' num2str(i) '.set'],'filepath','C:\\Users\\cognitive\\Desktop\\Ben\\EC\\Sets');
...
EEG = pop_reref( EEG, []); 
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, i,'setname',['S' num2str(i)],'overwrite','on','gui','off'); 
EEG = eeg_checkset( EEG );
...
% % Bandpass
% EEG = pop_eegfiltnew(EEG, 0.5,40,1690,0,[],1);
% [ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,'overwrite','on','saveold',['/Users/admin/BGU Drive/Graduate_Studies/CPL/EEG_Data/Erez Resting State/EC_no_time/RS_EC_S' num2str(i) '.set'],'gui','off'); 
% EEG = eeg_checkset( EEG );
